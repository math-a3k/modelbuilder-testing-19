...
## Project Structure
    ...
    ├── modelbuilder_testing_19  # Django project configurations
...
1. Clone this repo and `cd modelbuilder_testing_19`
...
2. Clone this repo and `cd modelbuilder_testing_19`
